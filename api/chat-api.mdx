...
description: "Create chat sessions, send messages, and retrieve conversation history via API to build conversational AI-powered support experiences in your product."
---
