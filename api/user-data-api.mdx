...
description: "Register a webhook so My AskAI can fetch live user context before each conversation, enabling your AI agent to give personalised, account-aware support answers."
---
