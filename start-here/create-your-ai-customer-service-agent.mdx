...
<Steps>
  ...
  <Step title="Connect to your helpdesk">
    ...
    <Note>
      Each helpdesk integration works slightly differently. If you run into issues, consult the dedicated integration guides in the [Channels](/features/channels/overview) section of this documentation.
    </Note>
  </Step>
